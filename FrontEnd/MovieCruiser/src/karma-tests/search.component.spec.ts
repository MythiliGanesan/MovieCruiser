...
describe('SearchComponent', () => {
			...
			TestBed.configureTestingModule({
				...
				imports: [
					...
					RouterTestingModule.withRoutes([
						{ path: 'search-results', component: Dummy }
					])
				],
	...
	it(
		'should be able to make a search and set state of searchService',
		fakeAsync(() => {
			searchService = fixture.debugElement.injector.get(SearchService);
			searchInput = fixture.debugElement.nativeElement.querySelector(
				'#search-box'
			);
